...
public class MainScreenCareTaker extends JFrame{
	...
	public MainScreenCareTaker(UserModel userDetails) {
	...
	private void initialize() {
		...
		try {
			img = ImageIO.read(MainScreenCareTaker.class.getResource("/media/battery2.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
