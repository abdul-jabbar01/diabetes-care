...
public class Start extends JFrame {
	...
	private void initialize() {
		...
		panel_2.setBounds(130, 70, 525, 375);
		panel.add(panel_2);
		...
		JButton btnSubmit = new JButton("Simulation");
		
		// Action listener for the Simulation
		btnSubmit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				new SimulationMainScreen(null);
				frame.dispose();

			}
		});
		btnSubmit.setFont(new Font("Lucida Grande", Font.PLAIN, 17));
//		btnSubmit.setIcon(new ImageIcon(Start.class.getResource("/media/register4.png")));
		btnSubmit.setBounds(65, 115, 180, 163);
		panel_2.add(btnSubmit);

		JButton btnLogin = new JButton("Live");
...
//		btnLogin.setIcon(new ImageIcon(Start.class.getResource("/media/login2.png")));
